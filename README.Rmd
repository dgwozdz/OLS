...
```
<img src="pictures/histogram.png" style="display: block; margin: auto;" />
...
In this case, parallelization shortened the time required to run a function call. It should be taken into consideration that the number of models was `r 5831/n.models` times greater than previously.
